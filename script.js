...
function displayLyrics() {
    ...
    display.innerHTML = '';
    const endIdx = Math.min(lyrics.length - 1, currentLineIndex + 2); // Afficher jusqu'à current + 2 futurs max (les autres futurs non visibles)
    for (let i = 0; i <= endIdx; i++) {
        ...
        if (i < currentLineIndex) {
            ...
            div.onclick = () => {
                ...
                // Supprimer tous les timestamps après cette ligne
                ...
                displayLyrics();
                // Optionnel : reprendre la lecture si en cours
    ...
    // Auto-scroll pour centrer la ligne courante (ou la mettre visible)
